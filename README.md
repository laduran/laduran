...
- 🔭 In 2023 I left a full-time job with Intel to focus on building my [consulting business](www.sylvansoftworks.com) and enhance my skills in Machine Learning
  - Starting in January 2026 I work at [Envoy Inc.](https://www.envoy.com) This is my first real experience working in a SF startup culture. I have already learned so much about organizations and the new way of coding (agents, "Ralph" loops, compound engineering). However the actual programming languages themselves were a bit outdated ( [Kotlin](https://kotlinlang.org/) being the exception. )
  ...
  - And before that I worked at [Intel](https://www.intel.com) working on a lot of different projects: Larrabee (a GPGPU concept project that never shipped but spawned data center compute cards), Anypoint (home networking), ProShare (one of the original video conferencing applications)
